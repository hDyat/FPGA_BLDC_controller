// nios2_proc_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module nios2_proc_mm_interconnect_0 (
		...
		output wire [1:0]  speed_ref_s1_address,                    //                      speed_ref_s1.address
		input  wire [31:0] speed_ref_s1_readdata                    //                                  .readdata
	);
	...
	wire  [17:0] pwm_out_s1_agent_m0_address;                                                 // pwm_out_s1_agent:m0_address -> pwm_out_s1_translator:uav_address
	...
	wire  [94:0] pwm_out_s1_agent_rf_source_data;                                             // pwm_out_s1_agent:rf_source_data -> pwm_out_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] pwm_out_s1_agent_rsp_fifo_out_data;                                          // pwm_out_s1_agent_rsp_fifo:out_data -> pwm_out_s1_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                       // cmd_mux_002:src_valid -> pwm_out_s1_agent:cp_valid
	wire  [93:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> pwm_out_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                       // pwm_out_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [6:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> pwm_out_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                               // cmd_mux_002:src_startofpacket -> pwm_out_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                 // cmd_mux_002:src_endofpacket -> pwm_out_s1_agent:cp_endofpacket
	...
	wire  [31:0] speed_ref_s1_agent_m0_readdata;                                              // speed_ref_s1_translator:uav_readdata -> speed_ref_s1_agent:m0_readdata
	wire         speed_ref_s1_agent_m0_waitrequest;                                           // speed_ref_s1_translator:uav_waitrequest -> speed_ref_s1_agent:m0_waitrequest
	wire         speed_ref_s1_agent_m0_debugaccess;                                           // speed_ref_s1_agent:m0_debugaccess -> speed_ref_s1_translator:uav_debugaccess
	wire  [17:0] speed_ref_s1_agent_m0_address;                                               // speed_ref_s1_agent:m0_address -> speed_ref_s1_translator:uav_address
	wire   [3:0] speed_ref_s1_agent_m0_byteenable;                                            // speed_ref_s1_agent:m0_byteenable -> speed_ref_s1_translator:uav_byteenable
	wire         speed_ref_s1_agent_m0_read;                                                  // speed_ref_s1_agent:m0_read -> speed_ref_s1_translator:uav_read
	wire         speed_ref_s1_agent_m0_readdatavalid;                                         // speed_ref_s1_translator:uav_readdatavalid -> speed_ref_s1_agent:m0_readdatavalid
	wire         speed_ref_s1_agent_m0_lock;                                                  // speed_ref_s1_agent:m0_lock -> speed_ref_s1_translator:uav_lock
	wire  [31:0] speed_ref_s1_agent_m0_writedata;                                             // speed_ref_s1_agent:m0_writedata -> speed_ref_s1_translator:uav_writedata
	wire         speed_ref_s1_agent_m0_write;                                                 // speed_ref_s1_agent:m0_write -> speed_ref_s1_translator:uav_write
	wire   [2:0] speed_ref_s1_agent_m0_burstcount;                                            // speed_ref_s1_agent:m0_burstcount -> speed_ref_s1_translator:uav_burstcount
	wire         speed_ref_s1_agent_rf_source_valid;                                          // speed_ref_s1_agent:rf_source_valid -> speed_ref_s1_agent_rsp_fifo:in_valid
	wire  [94:0] speed_ref_s1_agent_rf_source_data;                                           // speed_ref_s1_agent:rf_source_data -> speed_ref_s1_agent_rsp_fifo:in_data
	wire         speed_ref_s1_agent_rf_source_ready;                                          // speed_ref_s1_agent_rsp_fifo:in_ready -> speed_ref_s1_agent:rf_source_ready
	wire         speed_ref_s1_agent_rf_source_startofpacket;                                  // speed_ref_s1_agent:rf_source_startofpacket -> speed_ref_s1_agent_rsp_fifo:in_startofpacket
	wire         speed_ref_s1_agent_rf_source_endofpacket;                                    // speed_ref_s1_agent:rf_source_endofpacket -> speed_ref_s1_agent_rsp_fifo:in_endofpacket
	wire         speed_ref_s1_agent_rsp_fifo_out_valid;                                       // speed_ref_s1_agent_rsp_fifo:out_valid -> speed_ref_s1_agent:rf_sink_valid
	wire  [94:0] speed_ref_s1_agent_rsp_fifo_out_data;                                        // speed_ref_s1_agent_rsp_fifo:out_data -> speed_ref_s1_agent:rf_sink_data
	wire         speed_ref_s1_agent_rsp_fifo_out_ready;                                       // speed_ref_s1_agent:rf_sink_ready -> speed_ref_s1_agent_rsp_fifo:out_ready
	wire         speed_ref_s1_agent_rsp_fifo_out_startofpacket;                               // speed_ref_s1_agent_rsp_fifo:out_startofpacket -> speed_ref_s1_agent:rf_sink_startofpacket
	wire         speed_ref_s1_agent_rsp_fifo_out_endofpacket;                                 // speed_ref_s1_agent_rsp_fifo:out_endofpacket -> speed_ref_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                       // cmd_mux_004:src_valid -> speed_ref_s1_agent:cp_valid
	wire  [93:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> speed_ref_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                       // speed_ref_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> speed_ref_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                               // cmd_mux_004:src_startofpacket -> speed_ref_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                 // cmd_mux_004:src_endofpacket -> speed_ref_s1_agent:cp_endofpacket
	...
	wire  [94:0] lcd_s1_agent_rf_source_data;                                                 // LCD_s1_agent:rf_source_data -> LCD_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] lcd_s1_agent_rsp_fifo_out_data;                                              // LCD_s1_agent_rsp_fifo:out_data -> LCD_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> LCD_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                       // LCD_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> LCD_s1_agent:cp_channel
	...
	wire  [17:0] adc_data_s1_agent_m0_address;                                                // adc_data_s1_agent:m0_address -> adc_data_s1_translator:uav_address
	...
	wire  [94:0] adc_data_s1_agent_rf_source_data;                                            // adc_data_s1_agent:rf_source_data -> adc_data_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] adc_data_s1_agent_rsp_fifo_out_data;                                         // adc_data_s1_agent_rsp_fifo:out_data -> adc_data_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                       // cmd_mux_006:src_valid -> adc_data_s1_agent:cp_valid
	wire  [93:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> adc_data_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                       // adc_data_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> adc_data_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                               // cmd_mux_006:src_startofpacket -> adc_data_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                 // cmd_mux_006:src_endofpacket -> adc_data_s1_agent:cp_endofpacket
	...
	wire         pwm_out_s1_agent_rp_valid;                                                   // pwm_out_s1_agent:rp_valid -> router_004:sink_valid
	wire  [93:0] pwm_out_s1_agent_rp_data;                                                    // pwm_out_s1_agent:rp_data -> router_004:sink_data
	wire         pwm_out_s1_agent_rp_ready;                                                   // router_004:sink_ready -> pwm_out_s1_agent:rp_ready
	wire         pwm_out_s1_agent_rp_startofpacket;                                           // pwm_out_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         pwm_out_s1_agent_rp_endofpacket;                                             // pwm_out_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         speed_ref_s1_agent_rp_valid;                                                 // speed_ref_s1_agent:rp_valid -> router_006:sink_valid
	wire  [93:0] speed_ref_s1_agent_rp_data;                                                  // speed_ref_s1_agent:rp_data -> router_006:sink_data
	wire         speed_ref_s1_agent_rp_ready;                                                 // router_006:sink_ready -> speed_ref_s1_agent:rp_ready
	wire         speed_ref_s1_agent_rp_startofpacket;                                         // speed_ref_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         speed_ref_s1_agent_rp_endofpacket;                                           // speed_ref_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [93:0] lcd_s1_agent_rp_data;                                                        // LCD_s1_agent:rp_data -> router_007:sink_data
	...
	wire         adc_data_s1_agent_rp_valid;                                                  // adc_data_s1_agent:rp_valid -> router_008:sink_valid
	wire  [93:0] adc_data_s1_agent_rp_data;                                                   // adc_data_s1_agent:rp_data -> router_008:sink_data
	wire         adc_data_s1_agent_rp_ready;                                                  // router_008:sink_ready -> adc_data_s1_agent:rp_ready
	wire         adc_data_s1_agent_rp_startofpacket;                                          // adc_data_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         adc_data_s1_agent_rp_endofpacket;                                            // adc_data_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         pwm_out_s1_agent_rdata_fifo_src_valid;                                       // pwm_out_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] pwm_out_s1_agent_rdata_fifo_src_data;                                        // pwm_out_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         pwm_out_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_002:in_0_ready -> pwm_out_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                           // avalon_st_adapter_002:out_0_valid -> pwm_out_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                            // avalon_st_adapter_002:out_0_data -> pwm_out_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                           // pwm_out_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                           // avalon_st_adapter_002:out_0_error -> pwm_out_s1_agent:rdata_fifo_sink_error
	...
	wire         speed_ref_s1_agent_rdata_fifo_src_valid;                                     // speed_ref_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] speed_ref_s1_agent_rdata_fifo_src_data;                                      // speed_ref_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         speed_ref_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_004:in_0_ready -> speed_ref_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                           // avalon_st_adapter_004:out_0_valid -> speed_ref_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                            // avalon_st_adapter_004:out_0_data -> speed_ref_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                           // speed_ref_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                           // avalon_st_adapter_004:out_0_error -> speed_ref_s1_agent:rdata_fifo_sink_error
	...
	wire         adc_data_s1_agent_rdata_fifo_src_valid;                                      // adc_data_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] adc_data_s1_agent_rdata_fifo_src_data;                                       // adc_data_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         adc_data_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_006:in_0_ready -> adc_data_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                           // avalon_st_adapter_006:out_0_valid -> adc_data_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                            // avalon_st_adapter_006:out_0_data -> adc_data_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                           // adc_data_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                           // avalon_st_adapter_006:out_0_error -> adc_data_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) speed_ref_s1_translator (
		.clk                    (clk_0_clk_clk),                           //                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (speed_ref_s1_agent_m0_address),           // avalon_universal_slave_0.address
		.uav_burstcount         (speed_ref_s1_agent_m0_burstcount),        //                         .burstcount
		.uav_read               (speed_ref_s1_agent_m0_read),              //                         .read
		.uav_write              (speed_ref_s1_agent_m0_write),             //                         .write
		.uav_waitrequest        (speed_ref_s1_agent_m0_waitrequest),       //                         .waitrequest
		.uav_readdatavalid      (speed_ref_s1_agent_m0_readdatavalid),     //                         .readdatavalid
		.uav_byteenable         (speed_ref_s1_agent_m0_byteenable),        //                         .byteenable
		.uav_readdata           (speed_ref_s1_agent_m0_readdata),          //                         .readdata
		.uav_writedata          (speed_ref_s1_agent_m0_writedata),         //                         .writedata
		.uav_lock               (speed_ref_s1_agent_m0_lock),              //                         .lock
		.uav_debugaccess        (speed_ref_s1_agent_m0_debugaccess),       //                         .debugaccess
		.av_address             (speed_ref_s1_address),                    //      avalon_anti_slave_0.address
		.av_readdata            (speed_ref_s1_readdata),                   //                         .readdata
		.av_write               (),                                        //              (terminated)
		.av_read                (),                                        //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (speed_ref_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (speed_ref_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (speed_ref_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (speed_ref_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (speed_ref_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (speed_ref_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (speed_ref_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (speed_ref_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (speed_ref_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (speed_ref_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (speed_ref_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (speed_ref_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (speed_ref_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (speed_ref_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (speed_ref_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (speed_ref_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (speed_ref_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (speed_ref_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (speed_ref_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (speed_ref_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (speed_ref_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (speed_ref_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (speed_ref_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (speed_ref_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (speed_ref_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (speed_ref_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),             //                .error
		.rdata_fifo_src_ready    (speed_ref_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (speed_ref_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (speed_ref_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) speed_ref_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.in_data           (speed_ref_s1_agent_rf_source_data),             //        in.data
		.in_valid          (speed_ref_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (speed_ref_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (speed_ref_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (speed_ref_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (speed_ref_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (speed_ref_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (speed_ref_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (speed_ref_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (speed_ref_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	nios2_proc_mm_interconnect_0_router router (
	...
	nios2_proc_mm_interconnect_0_router_001 router_001 (
	...
	nios2_proc_mm_interconnect_0_router_002 router_002 (
	...
	nios2_proc_mm_interconnect_0_router_003 router_003 (
	...
	nios2_proc_mm_interconnect_0_router_002 router_004 (
	...
	nios2_proc_mm_interconnect_0_router_003 router_005 (
	...
	nios2_proc_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (speed_ref_s1_agent_rp_ready),             //      sink.ready
		.sink_valid         (speed_ref_s1_agent_rp_valid),             //          .valid
		.sink_data          (speed_ref_s1_agent_rp_data),              //          .data
		.sink_startofpacket (speed_ref_s1_agent_rp_startofpacket),     //          .startofpacket
		.sink_endofpacket   (speed_ref_s1_agent_rp_endofpacket),       //          .endofpacket
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_router_002 router_007 (
	...
	nios2_proc_mm_interconnect_0_router_002 router_008 (
	...
	nios2_proc_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_proc_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	nios2_proc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (speed_ref_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (speed_ref_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (speed_ref_s1_agent_rdata_fifo_src_ready), //         .ready
